...
insert into tb_usuario (id, login) values (6, 'faminto_4');
insert into tb_usuario (id, login) values (7, 'faminto_5');
insert into tb_usuario (id, login) values (8, 'faminto_6');
insert into tb_usuario (id, login) values (9, 'faminto_7');
insert into tb_usuario (id, login) values (10, 'faminto_8');
insert into tb_usuario (id, login) values (11, 'faminto_9');
insert into tb_usuario (id, login) values (12, 'faminto_10');
...
-- Eleições
insert into tb_eleicao (id, inclusao, id_restaurante, votos) values (1, '2020-03-18', 7, 2);
insert into tb_eleicao (id, inclusao, id_restaurante, votos) values (2, '2020-03-19', 8, 2);
insert into tb_eleicao (id, inclusao, id_restaurante, votos) values (3, '2020-03-20', 9, 2);